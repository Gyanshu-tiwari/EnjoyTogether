...
export const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-bg-primary flex flex-col items-center p-6 text-white selection:bg-brand/25 font-sans select-none w-full relative overflow-hidden">
